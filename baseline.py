"""
GatiAI — Baseline Inference Script
...
def run_baseline(task_id: str, seed: int = 42, verbose: bool = True) -> dict:
...
def run_all_baselines():
    ...
    print("\n" + "="*60)
    print(" SUPPLY CHAIN DISRUPTION GYM — BASELINE SCORES")
    print("="*60)

    results = {}
    for task_id in ["task1", "task2", "task3"]:
        r = run_baseline(task_id=task_id, seed=42, verbose=True)
        results[task_id] = r
